...
metadata:
  homepage: https://github.com/LaxmanNepal/Ambition
---
...
- `length`: optional number for password/random operations.
...
- `tip_percent`, `people`: optional tip fields.
...
Never invent live data. Network results must be labeled as fetched data and may be unavailable. Do not treat search snippets as authoritative for high-stakes decisions. For financial, medical, legal, or safety-critical questions, use fetched data only as supporting information and advise verification from an authoritative source.
